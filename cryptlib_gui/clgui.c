...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        GuiLabel((Rectangle) { 24, 4, 350, 20 }, "Enter text and press Enter to encrypt:");

        bool textBoxFocused = GuiTextBox((Rectangle) { 24, 24, 350, 30 },
            inputText, sizeof(inputText), true);
